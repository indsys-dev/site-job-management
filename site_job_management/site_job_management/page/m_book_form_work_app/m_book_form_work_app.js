...
// 🔥 Runs every time page is opened (refresh fix)
frappe.pages['m-book-form-work-app'].on_page_show = function(wrapper) {
    ...
    load_formwork_data(wrapper.page, pour_card);
};
...
// MAIN DATA LOADER
// ===============================
function load_formwork_data(page, pour_card) {
    ...
    frappe.call({
        ...
        callback: function(r) {
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6 p-2">
                        <div clas="card p-3">
                            <div class="d-flex justify-content-between align-items-center"
                                ...
                                onclick="toggleDetails('mbookProjectDetailsBox','mbookProjectArrow')">

                                <h4 class="mb-0">Project Details</h4>
                                <span id="mbookProjectArrow">&#9660;</span>
                            </div>

                            <div id="mbookProjectDetailsBox" style="display:none; margin-top:15px;">
                    ...
                    <div class="col-md-6 p-2">
                        <div class="card p-3">
                            <div class="d-flex justify-content-between align-items-center"
                                style="cursor:pointer;"
                                onclick="toggleDetails('mbookPourDetailsBox','mbookPourArrow')">

                                <h4 class="mb-0">Pour Card Details</h4>
                                <span id="mbookPourArrow">&#9660;</span>
                            </div>

                            <div id="mbookPourDetailsBox" style="display:none; margin-top:15px;">
            ...
            // ==================================================
            if (data.signature && data.pour_card.mbook_form_status === "Approved") {
